  ...
  async function onSubmit(data: FormData) {
    ...
    try {
      ...
      const { error: qrError } = await supabase
        ...
        .insert({
          event_id: eventId,
          // QR code will be auto-generated by database trigger
        } as any)
      
      if (qrError) {
        console.error("Error creating QR code:", qrError)
        // Continue despite QR code error
      }
                    ...
                    render={({ field }) => (
                      <FormItem style={{ gridColumn: isMobile ? 'span 1' : 'span 2' }}>
                        ...
                        <div className="flex items-center space-x-2">
                          <span className="text-muted-foreground text-sm">cloudburstapp.com/events/</span>
                          <FormControl>
                            <Input 
                              className="max-w-sm" 
