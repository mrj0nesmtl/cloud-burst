...
export default function FacialRecognitionPage() {
  ...
  return (
    <div style={{ 
      ...
      <Alert className={isMobile ? 'py-3 px-4 text-sm' : ''}>
        <AlertCircle className="h-4 w-4" />
        <AlertTitle className={isMobile ? 'text-base' : ''}>Feature in development</AlertTitle>
      ...
      <div style={{ 
        ...
        <Card>
          <CardHeader style={{ paddingBottom: '8px' }} className={isMobile ? 'py-3 px-4' : undefined}>
            <CardTitle className="text-lg flex items-center gap-2">
              <UserSearch className="h-5 w-5 text-primary" />
              Simplified Search
            </CardTitle>
          </CardHeader>
          <CardContent className={isMobile ? 'py-2 px-4' : undefined}>
            <p className="text-sm">
