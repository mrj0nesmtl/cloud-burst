...
export default async function QRCodesPage() {
  ...
  return (
    <div style={{ 
        ...
        <div style={{ 
          ...
          {events && events.length > 0 ? (
            events.map(event => {
              ...
              return (
                <Card key={event.id} className="dark-mode-border" style={{ 
                  ...
                  <CardHeader className="dark-mode-border" style={{ 
                    padding: '16px',
                  ...
                  <CardContent style={{ 
                    ...
                    <div style={{ 
                      ...
                      <div className="dark-mode-border-heavy" style={{ 
                  ...
                  <CardFooter className="dark-mode-border" style={{ 
                    padding: '12px 16px',
      ...
      {/* Information card */}
      <Card className="dark-mode-border" style={{ 
        border: '2px solid var(--border)', 
        background: 'var(--card)',
        borderRadius: '8px',
        overflow: 'hidden',
        ...
        <CardHeader className="dark-mode-border" style={{ padding: '16px', borderBottom: '2px solid var(--border)' }}>
