...
export default async function EventsLayout({ children }: EventsLayoutProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <header className="border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto py-4 px-4 flex justify-between items-center">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg">Cloud Burst</span>
          </Link>
          
          <nav className="flex items-center gap-4">
            <Link href="/events" className="text-sm font-medium hover:text-blue-500 transition-colors">
              Public Events
            </Link>
            <Link href="/marketing/about" className="text-sm font-medium hover:text-blue-500 transition-colors">
              About
            </Link>
            <Link href="/marketing/pricing" className="text-sm font-medium hover:text-blue-500 transition-colors">
              Pricing
            </Link>
            <Link href="/marketing/contact" className="text-sm font-medium hover:text-blue-500 transition-colors">
              Contact
            </Link>
      ...
      {/* Footer */}
      <footer className="border-t border-border/40 py-8 px-4 bg-background/95">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <Link href="/" className="flex items-center gap-2 mb-4">
                <CloudLightning className="h-5 w-5 text-blue-500" />
                <span className="font-bold">Cloud Burst</span>
              </Link>
